...
System.register("pages/call.html!github:systemjs/plugin-text@0.0.2", [], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = "<div class=\"page-intro orange lighten-5 white-text row\">\n  <div class=\"col m12 s12\">\n    <div class=\"container\">\n      <div class=\"row\">\n        <div class=\"col m10 s12\">\n          <span class=\"brown-text text-darken-4\">\n            <h2 class=\"m12\">Connect with someone now!</h2>\n          </span>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n<div class=\"section no-pad-bot\">\n  <div class=\"container\">\n    <div class=\"row\" id=\"whiteness\">\n      <div class=\"col l12 m12 s12\">\n        <div class=\"card brown darken-1\">\n          <div class=\"card-content white-text\">\n            <span class=\"card-title\">Determining Whiteness...</span>\n            <p>Please allow <strong>White</strong>Save.me to access your camera. By starting your session, you are agreeing with our <a href=\"#terms\">terms and conditions.</a> Our patented facial color recognition software&#8482; will determine your Whiteness. Based on your results we will link you with a White Savior or a non-White Savee via a live video chat session (must be 13 or older) so you can connect and start ending inequality by giving or getting privilege and advice right through your device. For more information on how it works, <a href=\"#how\">click here</a> or check out our <a href=\"#faq\">FAQs</a> and our amazing <a href=\"#success\">Success Stories!</a></p>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col s9 m9 l8\">\n        <div class=\"card\">\n          <div class=\"card-image\">\n            <video id=\"peerVideo\" poster=\"img/loader.gif\" style=\"width:100%; height:auto\"></video>\n            <span class=\"card-title\">Video</span>\n          </div>\n        </div>\n      </div>\n      <div class=\"col s3 m3 l4\">\n        <div class=\"card\">\n          <div class=\"card-image\">\n            <canvas id=\"inputCanvas\" class=\"responsive-img\" width=\"260\" height=\"180\" style=\"width:100%; height:auto\"></canvas>\n          </div>\n          <div class=\"card-content\" id=\"white\">\n            <p>&nbsp;</p>\n          </div>\n          <div class=\"card-action\">\n            <a class=\"waves-effect waves-#000000 black btn\" onclick=\"javascript:window.location.reload()\" href=\"#home\">Quit Video Call</a>\n          </div>\n        </div>\n      </div>\n    </div>\n    <canvas id=\"outputCanvas\" class=\"responsive-img\" width=\"280\" height=\"200\" style=\"display:none\"></canvas>\n    <video id=\"inputVideo\" autoplay muted loop style=\"display:none\"></video>\n    </div>\n  </div>\n</div>\n";
  global.define = __define;
  return module.exports;
});
...
System.register("pages/success.html!github:systemjs/plugin-text@0.0.2", [], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = "<div class=\"page-intro orange lighten-5 white-text row\">\n\t<div class=\"col m12 s12\">\n    \t<div class=\"container\">\n        \t<div class=\"row\">\n            \t<div class=\"col m10 s12\">\n                <span class=\"brown-text text-darken-4\">\n                <h2 class=\"m12\">Saving one person at a time, at scale and for profit.</h2>\n\n                </div>\n             \t\t<div class=\"col header-icon-image m4\">\n                \t</div>\n             </div>\n         </div>\n     </div>\n</div>\n\n<!-- Success Stories Section -->\n\n<div class=\"container\">\n  <div class=\"section no-pad-bot\" id=\"index-banner\">\n    <div class=\"col m12 s12\">\n      <div class=\"row\">\n          <div class=\"col m12 s12 light\">\n            <p></p><div class=\"rich-text\"><h4>Success Stories</h4>\n                <hr><h5>Our fast growth has changed the lives of thousands. Below are just a few stories in which our highly qualified White Saviors have helped underprivileged Savees get ahead.</h5>\n\n\n                </div>\n            </div>\n         </div>\n       </div>\n\n       <blockquote>\"I absolutely love WhiteSave.me. I can hop on for a second, do some social good real quick, then get back to finding stuff to paraphrase in my books!\" <br><em>Malcolm Fadwell, author</em> </blockquote>\n\n\n   <div class=\"section\">\n\n\n      <div class=\"col s12 m6 l6\">\n        <div class=\"card-panel hoverable orange lighten-5 z-depth-1\">\n          <div class=\"row\">\n            <div class=\"col s2\">\n              <img src=\"img/savior_bill.jpg\" alt=\"Bill\" class=\"circle responsive-img\" >\n            </div>\n            <div class=\"col s10\">\n              <span class=\"black-text\">\n                “It was really great delivering some privilege through <strong>White</strong>Save.me. I’ve always felt that these people just need to be more motivated and hardworking and they’ll get ahead. <br><br>When I read that only 1% of CEOs are Black, I made sure to do a little research on Mark Zuckerberg so I could talk to some of these inner city kids about him. I'm pretty sure he didn't finish college, and look at him now&mdash;he fast tracked it right to the top. So I got to thinking&mdash;if we just teach these kids to code, they’ll be starting companies in no time. Or they can go work in Silicon Valley. Heck, by the time these kids graduate from high school in a few years, those Left Coast hippies will probably be open to hiring Blacks for tech jobs. <br><br>Right now most of these kids have this fantasy that they’ll grow up to be famous rappers or ball players. It’s a lot more realistic to think about being the next Mark Zuckerberg or Bill Gates, because that requires a real skill - coding.”\n               <br><br><em>Bill helped inner-city kids see that becoming a billionaire through coding and entrepreneurship is a lot more realistic than doing it via professional sports or rap music.</em>\n              </span>\n            </div>\n          </div>\n        </div>\n      </div>\n\n\n\n\n      <div class=\"col s12 m6 l6\">\n        <div class=\"card-panel hoverable orange lighten-5 z-depth-1\">\n          <div class=\"row\">\n            <div class=\"col s2\">\n              <img src=\"img/savior_trevor.jpg\" alt=\"Trevor\" class=\"circle responsive-img\" >\n            </div>\n            <div class=\"col s10\">\n              <span class=\"black-text\">\n                “I got connected up with Maria Luisa. She was having trouble moving up the ladder in the tech company she’s been at for a while. She kept saying it was hard for women to get ahead in tech, but I’m pretty tired of that excuse. Tech companies put a lot of emphasis on how well employees fit in with the culture, and I could see that even though Maria Luisa knows her stuff, she just doesn’t know how to hang. <br><br>I gave her some tips– like changing her name to Mary Louise, dressing more White, not speaking Spanish at work, 'leaning in' more, and mainly just chillaxing and not being so angry all the time! She was paying for the Premium Model of <strong>White</strong>Save.me so I just hopped in a Buber and went over to have lunch with her in person a few times. I think being seen with me really helped her out. They started inviting her to Happy Hour, and she finally got promoted last month. They also put her in charge of the company’s “Diversity Working Group!”\n               <br><br><em>Trevor helped Maria Luisa (Mary Louise), age 28, chillax so she could get a promotion.</em>\n              </span>\n            </div>\n          </div>\n        </div>\n      </div>\n\n\n\n\n      <div class=\"col s12 m6 l6\">\n        <div class=\"card-panel hoverable orange lighten-5 z-depth-1\">\n          <div class=\"row\">\n            <div class=\"col s2\">\n              <img src=\"img/savior_hunter.jpg\" alt=\"\" class=\"circle responsive-img\" >\n            </div>\n            <div class=\"col s10\">\n              <span class=\"black-text\">\n                “I linked with this 20 year old chick who had accidentally gotten pregnant and was kind of freaking out. She started giving me a sob story, but I stopped her right there -- she was really overthinking things. I have a ton of friends who are into having a kid on their own. They actually prefer it – it’s like a feminist statement or badge of honor or something. I was like, seriously, just embrace it and get on with things. Stop making such a big deal out of it. <br><br>Plus there are all these great apps out there now that help women track their cycles. I’m not sure why accidental pregnancy is even a thing any more. Shanaya didn’t seem to think I understood her situation, and I had to repeat myself several times, but I figure she’s better off now for having heard a White male perspective on things. It all really comes down to personal choice. I felt really good about giving her some orientation, and I’m guessing she’ll download one of those apps I recommended.”\n               <br><br><em>Hunter explained to Shanaya, age 20, how to embrace the freedom and feminism of being a single mom.</em>\n              </span>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <div class=\"col s12 m6 l6\">\n        <div class=\"card-panel hoverable orange lighten-5 z-depth-1\">\n          <div class=\"row\">\n            <div class=\"col s2\">\n              <img src=\"img/savior_bruce.jpg\" alt=\"Bruce\" class=\"circle responsive-img\" >\n            </div>\n            <div class=\"col s10\">\n              <span class=\"black-text\">\n               “I help out a lot on <strong>White</strong>Save.me, delivering privilege all over the place. Once I helped this kid, Jayden, when he got stopped by the cops for walking around in his neighborhood. I told him to be extra polite and let the cops stop and search without a struggle. I mean, these were Black kids walking around without a legitimate destination, aside from going to the store to get food -- they probably looked like thugs up to no good. <br><br>I told Jayden to get his hands up and let the cops see his phone with my face on the video, so they'd know I was with him and that he didn’t have a gun. Eventually I had him hand his phone over and I talked the cops into letting him and his pals go with just a warning, as long as they went straight back to the house and kept me on the phone till they got there. If more of these kids had a good attitude and folks like me to accompany them, I really think we'd see the end of this whole anti-cop thing.”\n\n               <br><br><em>With Bruce’s help, Jayden, age 17, avoided arrest while walking in his own neighborhood. </em>\n              </span>\n            </div>\n          </div>\n        </div>\n      </div>\n\n\n\n\n\n      <div class=\"col s12 m6 l6\">\n        <div class=\"card-panel hoverable orange lighten-5 z-depth-1\">\n          <div class=\"row\">\n            <div class=\"col s2\">\n              <img src=\"img/savior_topher.jpg\" alt=\"Topher\" class=\"circle responsive-img\" >\n            </div>\n            <div class=\"col s10\">\n              <span class=\"black-text\">\n               “I delivered privilege and development to a whole village in rural Kenya. They were having trouble with their cassava and maize crops over there because of drought. I support an organization called World Aid Corps, and they've partnered up with <strong>White</strong>Save.me so that subsistence farmers can get agricultural advice from White Americans through their mobile phones. They just have to come up with enough money to text in some questions and it goes through Google Translate. It’s really pretty cool.   <br><br>Right after I signed up, I got a text from a farmer. I told him about a Ted Talk I saw on hydroponic plant systems that grow on the sides of buildings. He said they don’t have tall buildings in their part of Kenya, and he was concerned about getting any of the equipment I mentioned having seen on the Ted Talk, but I think he's just a little backwards and unwilling to try new things. I helped him see that he was stuck in his old ways, and that a little bit of determination and disruptive thinking can go a long way towards overcoming obstacles. I think he felt a lot more motivated to try to innovate something after texting with me.\n               <br><br><em>Topher helped a whole community in rural Kenya avoid famine by spreading some ideas he heard on a Ted Talk. </em>\n              </span>\n            </div>\n          </div>\n        </div>\n      </div>\n\n\n      <div class=\"col s12 m6 l6\">\n        <div class=\"card-panel hoverable orange lighten-5 z-depth-1\">\n          <div class=\"row\">\n            <div class=\"col s2\">\n              <img src=\"img/savior_john.jpg\" alt=\"\" class=\"circle responsive-img\" >\n            </div>\n            <div class=\"col s10\">\n              <span class=\"black-text\">\n               “I talked with this guy, James, whose son kept getting suspended for being late to middle school. He was really at a loss about how to handle it. I told him that first off, he should join the PTA so he could be more involved in his son's school. I don’t have kids of my own, but I'm pretty good at giving advice to people on how to raise them. <br><br> I also told James that it's important for his son to take personal responsibility. I know from media reports that Black kids mature faster than White kids -- I mean, the cops are always mistaking them for being older than they really are. So I figure James Junior should be able to get himself to school on his own whether his parents are home or not. If you ask me, James and his wife are also avoiding personal responsibility for their kid's education by working so many jobs and not being home for him. It's a two-way street here.  <br><br>I told James it was a pretty clear cut case of lack of responsibility all around. James disagreed with me, and even though he seemed really articulate when we spoke, I guess the concept of personal responsibiity is hard to explain to some people. I hope he'll reflect a little on it, so he'll see I'm right.\n\t\t\t\t\t\t\t<br><br><em>John gave James, age 32, valuable insight into the importance of personal responsibility.</em>\n              </span>\n            </div>\n          </div>\n        </div>\n      </div>\n\n    </div>\n\n\n  </div>\n</div>\n";
  global.define = __define;
  return module.exports;
});
...
System.register("pages/contact.html!github:systemjs/plugin-text@0.0.2", [], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = "<div class=\"page-intro orange lighten-5 white-text row\">\n  <div class=\"col s12\">\n    <div class=\"container\">\n      <span class=\"brown-text text-darken-4\">\n        <h2>Get in touch with us!</h2>\n      </span>\n    </div>\n  </div>\n</div>\n<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col s12\">\n      <div class=\"flow-text\"><h4>We'd love your comments and feedback.</h4>\n        <hr>\n        <h5>Let us know what you thought of the site at help [at] whitesave [dot] me.</h5>\n      </div>\n    </div>\n  </div>\n</div>\n";
  global.define = __define;
  return module.exports;
});
...
System.register("pages/statement.html!github:systemjs/plugin-text@0.0.2", [], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = "<div class=\"container\">\n  <div class=\"flow-text\">\n    <p>We were brought together as a team through the Art-A-Hack initiative.</p>\n\n    <p>Our project is “Imbalances in Tech.” We want to push people to reflect on digital saviorism, the danger of biased algorithms and binary approaches, the ridiculousness of simple solutions to complex deep-seated problems, and the folly that techno-utopian fixes can address issues like poverty, inequality and exclusion without addressing power imbalances and the entrenched historical privilege of certain individuals, institutions, and nations.</p>\n\n    <p>To explore those topics, we chose to focus on a complex, historical, systemic and touchy issue – white privilege – because it is highlighted by and a strong driver of all of the above.</p>\n\n    <p>We created a real/fake tech start-up with a business model, an app, a cheesy self-centered founders story, and everything else that a real start up aimed at “doing social good” typically has. We used the language bandied about by those in tech and social good – focusing our fake start up on ‘doing good while making a profit.’ We purposely centered our fake app on white people and their user experiences, and set it up so that non-white people would foot the bill.</p>\n\n    <p>The app enables white man to ‘deliver privilege’ to the less privileged. We chose this language because ‘delivering privilege’ is just about as impossible as ‘delivering development’ or ‘delivering democracy’ through tech applications.</p>\n\n    <p>In order for someone to participate in the WhiteSave.me experience, they need to first prove their qualifications to be a White Savior through the “whiteness detector,” which is based on a faulty algorithm that uses a video camera to determine whether a person is white or not white. The algorithm is both simplistic and biased. It’s also often wrong. Once the app determines if a person is white or not, the person is matched a White Savior or a non-white ‘Savee’. The White Savior provides privileged answers to the Savee’s lack-of-privilege-related questions through SMS, voice, video or in person (depending on how much the Savee is willing to pay).</p>\n\n    <p>We created a satire because because satire can be deep and cutting, and it often makes people think while they laugh uncomfortably. We want people to look at this site and feel unsure if it’s real or not. We want people to feel uncomfortable with both imbalances in tech and white privilege. People of Color are normally well aware of the issues we highlight, but often White people shy away from talking about them or they talk about them in a way that puts whiteness at the center, reconfirming white privilege. Our site purposely puts white people at the center in a very over the top way, as commentary.</p>\n\n    <p>Through the project, we highlight how technological quick fix solutions are Band Aids that do nothing to resolve deep historical and institutionalized inequalities and biases. Tech often serves to distract people from these deeper issues and potential longer-term changes that will necessarily touch issues of power and require change by those who hold power. Through the “white or not” algorithm, we show how tech, as a binary tool, does not do a good job with nuances and complex issues. And race is not binary, especially considering that biological race doesn’t even exist.</p>\n\n    <p>From the start of the project, we’ve consulted and shared the project with a diverse group of advisors and testers (white and not white) for orientation, criticism, commentary and other feedback. The creation of the website and the fake app we were able to explore and comment on imbalances in tech and how they reflect the world’s wider imbalances in blatant ways as well as through subtler microaggressions.</p>\n\n    <p>We are not against technology or against people helping, but we do think the use of technology in social good and social change needs to be deeply thought about. The so-called ‘solutions’ need to be complex and deep, and they need to address issues of power.</p>\n\n    <p>We hope the project will generate discussion and reflection and we welcome and comments or feedback.</p>\n\n    <p>Juan, Dmytri and Linda<br>\n    WhiteSave.me<br>\n    The Imbalances in Tech Team at Art-A-Hack<br>\n    Contact us: <a href=mailto:help@whitesave.me>help@whitesave.me</p>\n</div>\n";
  global.define = __define;
  return module.exports;
});
...
System.register("lib/layout", ["components/header.html!github:systemjs/plugin-text@0.0.2", "components/footer.html!github:systemjs/plugin-text@0.0.2", "pages/about.html!github:systemjs/plugin-text@0.0.2", "pages/call.html!github:systemjs/plugin-text@0.0.2", "pages/success.html!github:systemjs/plugin-text@0.0.2", "pages/story.html!github:systemjs/plugin-text@0.0.2", "pages/faq.html!github:systemjs/plugin-text@0.0.2", "pages/home.html!github:systemjs/plugin-text@0.0.2", "pages/partners.html!github:systemjs/plugin-text@0.0.2", "pages/contact.html!github:systemjs/plugin-text@0.0.2", "pages/statement.html!github:systemjs/plugin-text@0.0.2", "lib/start"], function($__export) {
  "use strict";
...
("html{overflow-y:scroll;overflow-x:hidden}x-header{position:fixed;top:0;width:100%;z-index:999}#main{padding-top:55px}.icon-block{padding:0 15px}.slider .indicators .indicator-item.active{background-color:#000}nav{height:65px;line-height:65px}a{color:#f57c00}");
});
